...
class SHA512(object):
    ...
    def __init__(self, InputMessage = None):
        ...
        #Initialise the required internal standard variables:
        self._message = None
        self._messageLength = 0
        self._paddedLength = 0
        self._hashBuffer = [0x6A09E667F3BCC908, 0xBB67AE8584CAA73B, 0x3C6EF372FE94F82B, 0xA54FF53A5F1D36F1,0x510E527FADE682D1,
                            0x9B05688C2B3E6C1F, 0x1F83D9ABFB41BD6B, 0x5BE0CD19137E2179]
        self._k = [ 0x428a2f98d728ae22, 0x7137449123ef65cd, 0xb5c0fbcfec4d3b2f, 0xe9b5dba58189dbbc, 0x3956c25bf348b538, 0x59f111f1b605d019,
